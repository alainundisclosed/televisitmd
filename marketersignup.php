...
//      $mail->SMTPSecure = 'ssl';
		...
		$bodyContent = '<html><body  style="background-color:#36c1c8; font-family: "Roboto", sans-serif;"><div class="main_center" style="width:100%; max-width:480px; margin:0px auto;">
        	    <div class="main_cnntn" style="border-radius:5px;margin-top: 100px;border-bottom: 6px solid #067075;background-color:#fff;padding: 50px 30px;text-align:center;-webkit-box-shadow: 0px 0px 35px -2px rgba(0,0,0,0.57);-moz-box-shadow: 0px 0px 35px -2px rgba(0,0,0,0.57);box-shadow: 0px 0px 35px -2px rgba(0,0,0,0.57);"><i class="far fa-check-circle" style="color: green;font-size: 90px;"></i>
        		        <h1 style="color:#2d2d2d;font-size: 44px;">Email Confirmation</h1><p style="color:#505050; line-height: 23px;">Hello, you are almost ready to start with TelevistMD (Role: Marketer), simply click the big yellow button below to verify you email address.</p>
    	...
    	try {
    	    $db->query("UPDATE provider_allowed_marketers SET dmeAllowedMarketers=concat(dmeAllowedMarketers, ';$user;'), domDmeAllowedMarketers=concat(domDmeAllowedMarketers, ';$user;')");
    	} catch(Exception $e) {
    	   // 
    	}
    	
    	header("location:crm/marketer/profile.php");
   } else{ ?> 
...
<body class="sign_Uppage">
		...
		<div class="container">
			<h1 class="h1" style="color: #0382cc !important;">Marketers, MSO's, & SAAS partners Sign Up</h1>
			<div class="col-md-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									...
									<input type="email" class="form-control" name="emailid" id="email" tabindex="3" value="" required="">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									...
									<input type="tel" class="form-control phn" name="primaryPhone" id="primaryPhone" tabindex="4" value="" required="" pattern="^[^<>]*$" maxlength="20">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									<label class="control-label color_gry_lyt">Company Name</label>
									<input type="tel" class="form-control phn" name="companyName" id="companyName" tabindex="5" value="" required="">
								</div>
							</div>
						</div>
						<div class="row">
